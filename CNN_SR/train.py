...
if __name__ == '__main__':
    ...
    parser.add_argument('--eval-file', type=str, default="/path/CNN_SR/outputs/Dr_output_test_2.h5")
    parser.add_argument('--outputs-dir', type=str, default="/path/CNN_SR/outputs")
